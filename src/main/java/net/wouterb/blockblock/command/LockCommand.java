...
public class LockCommand {
    ...
    private static int run(ServerCommandSource source, LOCK_TYPES lockType, Collection<ServerPlayerEntity> targets, Identifier blockOrTag) throws CommandSyntaxException {
